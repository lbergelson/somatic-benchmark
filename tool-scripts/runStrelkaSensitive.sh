...
$STRELKA_INSTALL_DIR/bin/configureStrelkaWorkflow_cga.pl --normal=$normalBam --tumor=$tumorBam --ref=$ref --config=$libdir/strelka_config_bwa_cgaexome_sensitive.ini --output-dir=${outputdir}
